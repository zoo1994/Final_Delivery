					...
					<table class="table">
					  <thead class="table-light">
					    <tr class="row" style="height: 45px;">
							...
							<th class="col-1 text-center d-flex align-items-center"  style="">매장위치</th>
					  ...
					  <tbody class="table-light">
							<c:forEach items="${list}" var="vo">
								<tr class="row" style="">
							    	...
							    	<td class="col-1 text-center d-flex align-items-center" style=" ">${vo.location}</td>
...
<%-- 							    	<td class="col-1 text-center d-flex align-items-center" style=" ">
										...
										<button style="margin: 0 auto; font-weight: 500;" type="button" id="shopDeleteBtn${vo.couponId}" class="deleteBtn btn btn-info">
										  삭제
										</button>
							    	</td> --%>
							    </tr>
