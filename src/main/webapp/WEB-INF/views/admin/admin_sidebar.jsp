<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="d-flex sticky-top mt-5" style="/*  background-color: gray; */ height: 700px; width: 100px; position:fixed; top:250px; left: 30px;">
		<div style="height: 200px; width:100px; display: block; background-color: #fff;"></div>
