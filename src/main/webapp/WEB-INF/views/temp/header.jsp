		...
		<div class="container-fluid">
			...
			<a class="navbar-brand" href="/"
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item mx-3"><a class="nav-link active"
						aria-current="page" href="/event/list" style="font-size: 20px">이벤트</a>
					</li>
					...
					<c:choose>
						<c:when test="${empty member}">
							<li class="nav-item"><a class="nav-link btn btn-primary"
								href="/member/login"
								style="color: white; font-size: 20px; background-color: #FF8233 !important; border: #FF8233 !important">login</a>
							</li>
							<li class="nav-item"><a
								class="nav-link btn btn-primary mx-3" href="/member/join"
								style="color: white; font-size: 20px; background-color: #FF8233 !important; border: #FF8233 !important">Sign-Up</a>
							</li>
						</c:when>
						<c:otherwise>
							<li class="nav-item"><a class="nav-link btn btn-primary"
