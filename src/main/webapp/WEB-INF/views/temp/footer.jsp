...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	<link rel="stylesheet" href="/css/footer.css" />
		<footer class="footer">
			...
			<div class="footArea d-flex justify-content-between">
				<ul class="fUtil">
					<li class="privacy"><a href="https://www.mcdonalds.co.kr/kor/etc/private.do">개인정보 처리방침</a></li>
					<li><a href="https://www.mcdonalds.co.kr/kor/etc/location.do">위치정보 이용약관</a></li><!-- 추가 -->
					<li><a href="https://www.mcdonalds.co.kr/kor/etc/sitemap.do">사이트맵</a></li>
					<li><a href="https://www.mcdonalds.co.kr/kor/store/rental.do">임차문의</a></li>
					<li><a href="/qna/list" target="_blank" title="새창 열림">고객문의</a></li>
					<!-- <li><a href="javascript:systemCheck('https://voc.mcd.co.kr/MC/HOM/faqMain.jsp')" title="새창 열림">고객문의</a></li> -->					
				    <li><a href="https://www.mcdonalds.co.kr/kor/story/people/recruit.do">인재채용</a></li> 
				</ul>
				<div class="fInfo">
					<ul class="info">
						<li>한국맥도날드(유)</li> 
				...
				<ul class="fSns">
					...
					<li class="web_accessibility">
                       <a href="http://www.webwatch.or.kr/Situation/WA_Situation.html?MenuCD=110" class="web_accessibility" title="국가 공인 인증기관 : 웹와치" target="_blank">
                        <img src="https://www.mcdonalds.co.kr/kor/images/common/web_accessibility.png" alt="과학기술정보통신부 WEB ACCESSIBILITY 마크(웹 접근성 품질인증 마크)">
                    </a>
                    </li> 
				</ul>
			</div>	
