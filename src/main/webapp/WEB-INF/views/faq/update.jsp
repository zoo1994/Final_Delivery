...
<!-- 					<div  id="faqCategoryBtn">
					...
					<input hidden id="preCategory" value="${faqVO.category}" disabled="disabled">
						...
						<table class="table" style="">
						  <tbody>
						    <tr style="border: hidden;">
								<td class="col-4">
									<input style="width: 100%;" type="radio" class="btn-check" name="category" id="category1" value="1" autocomplete="off">
