...
<c:forEach items="${list}" var="vo">
	...
	<a href="./detail?menuNum=${vo.menuNum}&category=${category}"><img src="../resources/upload/menu/${vo.menuFileVO.fileName}" class="card-img-top" alt="..." style="width: 100%; height: 300px;"></a>
		<div class="card-body">			
